...
// Factories
let HangOutFlatlandFacory;

// contract object
let hangOutFlatLand;

async function getContractFactories() {
  HangOutFlatlandFacory = await ethers.getContractFactory("HangOutETHFlatland");
}

async function deployContract() {
  hangOutFlatLand = await HangOutFlatlandFacory.deploy(
    deployConfig.signer,
    deployConfig.fieldMerkleRoot,
    deployConfig.landsMerkleRoot
  );
  await hangOutFlatLand.deployed();
  deployResult.writeDeployedContract(
    "hangOutFlatLand",
    hangOutFlatLand.address,
    "HangOutFlatland",
    {
